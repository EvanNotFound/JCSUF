...
xhttp.onreadystatechange = function() {
	if (this.readyState == 4 && this.status == 200) {
		...
		document.getElementById("rating-0").innerHTML = art.likedbyyou?'<font color="#3cf">↑ ':'↑ '+art.like+art.likedbyyou?'</font> ':' '+art.dislikedbyyou?'<font color="#f31">↓ ':'↓ '+art.dislike+art.dislikedbyyou?'</font>':'';
