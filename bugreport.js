...
function processOrder(order) {
	...
	document.getElementById("order-"+order.oid).innerHTML += '<div class="content-container"><div class="content" id="content-'+order.oid+'"><font style="color:rgb(68,68,100);font-size:10px">Work Order ID '+order.oid+'</font>'+order.content+'</div></div>'
}